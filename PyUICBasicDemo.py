...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.ComboDevices = QtWidgets.QComboBox(self.gridLayoutWidget)
        self.ComboDevices.setGeometry(QtCore.QRect(10, 10, 291, 22))
        self.ComboDevices.setObjectName("ComboDevices")
        self.gridLayout.addWidget(self.ComboDevices, 2, 1, 1, 2)
        self.groupGrab = QtWidgets.QGroupBox(self.centralWidget)
        self.groupGrab.setEnabled(False)
        self.groupGrab.setGeometry(QtCore.QRect(1539, 180, 311, 171))
        self.groupGrab.setObjectName("groupGrab")
        self.gridLayoutWidget_2 = QtWidgets.QWidget(self.groupGrab)
        self.gridLayoutWidget_2.setGeometry(QtCore.QRect(9, 19, 302, 141))
        ...
        self.groupParam.setGeometry(QtCore.QRect(1539, 360, 311, 151))
        self.groupParam.setObjectName("groupParam")
        self.gridLayoutWidget_3 = QtWidgets.QWidget(self.groupParam)
        self.gridLayoutWidget_3.setGeometry(QtCore.QRect(10, 20, 301, 131))
        ...
        self.groupResult.setGeometry(QtCore.QRect(1539, 520, 311, 151))
        self.groupResult.setObjectName("groupResult")
        self.labelResult = QtWidgets.QLabel(self.groupResult)
        self.labelResult.setGeometry(QtCore.QRect(10, 20, 301, 131))
        self.labelResult.setFont(QFont("Arial", 72, QFont.Bold))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.groupInit.setTitle(_translate("MainWindow", "Initial"))
        self.bnClose.setText(_translate("MainWindow", "Close Device"))
        self.bnOpen.setText(_translate("MainWindow", "Open Device"))
        self.bnEnum.setText(_translate("MainWindow", "Query Devices"))
